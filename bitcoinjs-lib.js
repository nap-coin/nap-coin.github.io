  ...
  return (function () {
  ...
  })()(
    {
      ...
      5: [
        function (require, module, exports) {
          ...
          const Id = /* @__PURE__ */ new Uint8Array(
            ...
            process(view, offset) {
              ...
              for (let group = 0; group < 5; group++) {
                ...
                for (let i = 0; i < 16; i++) {
                  const tl =
                    ((0, utils_js_1.rotl)(
                      al + f(group, bl, cl, dl) + R_BUF[rl[i]] + hbl,
                      sl[i]
                    ) +
                      el) |
                    0;
                ...
                for (let i = 0; i < 16; i++) {
                  const tr =
                    ((0, utils_js_1.rotl)(
                      ar + f(rGroup, br, cr, dr) + R_BUF[rr[i]] + hbr,
                      sr[i]
                    ) +
                      er) |
                    0;
          ...
          class SHA1 extends _md_js_1.HashMD {
            ...
            process(view, offset) {
              ...
              for (let i = 0; i < 80; i++) {
                ...
                const T =
                  ((0, utils_js_1.rotl)(A, 5) + F + E + K + SHA1_W[i]) | 0;
                E = D;
                D = C;
    ...
    0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19
      ...
      8: [
        ...
        { "./_assert.js": 2, "@noble/hashes/crypto": 4 },
      ],
      9: [
        function (require, module, exports) {
          "use strict";
      ...
      15: [
        ...
        {
          "../typeFields": 40,
          "./global/globalXpub": 13,
          "./global/unsignedTx": 14,
          "./input/finalScriptSig": 16,
          "./input/finalScriptWitness": 17,
          "./input/nonWitnessUtxo": 18,
          "./input/partialSig": 19,
          "./input/porCommitment": 20,
          "./input/sighashType": 21,
          "./input/tapKeySig": 22,
          "./input/tapLeafScript": 23,
          "./input/tapMerkleRoot": 24,
          "./input/tapScriptSig": 25,
          "./input/witnessUtxo": 26,
          "./output/tapTree": 27,
          "./shared/bip32Derivation": 28,
          "./shared/checkPubkey": 29,
          "./shared/redeemScript": 30,
          "./shared/tapBip32Derivation": 31,
          "./shared/tapInternalKey": 32,
          "./shared/witnessScript": 33,
        },
      ],
      16: [
        function (require, module, exports) {
      ...
      26: [
        ...
        { "../../typeFields": 40, "../tools": 34, "../varint": 35, buffer: 72 },
      ],
      27: [
        function (require, module, exports) {
          (function (Buffer) {
        ...
        { "../../typeFields": 40, "../varint": 35, buffer: 72 },
      ],
      28: [
        function (require, module, exports) {
          (function (Buffer) {
      ...
      31: [
        ...
        { "../varint": 35, "./bip32Derivation": 28, buffer: 72 },
      ],
      32: [
        function (require, module, exports) {
          (function (Buffer) {
      ...
      38: [
        ...
        { "../converter": 15, "../converter/tools": 34, buffer: 72 },
      ],
      39: [
        function (require, module, exports) {
          (function (Buffer) {
      ...
      41: [
        ...
        { "../../../is-buffer/index.js": 77, "./converter": 15 },
      ],
      42: [
        function (require, module, exports) {
          (function (Buffer) {
      ...
      45: [
        ...
        { "./types": 71, buffer: 72, "varuint-bitcoin": 83 },
      ],
      46: [
        function (require, module, exports) {
          (function (Buffer) {
        ...
        {
          "@noble/hashes/ripemd160": 5,
          "@noble/hashes/sha1": 6,
          "@noble/hashes/sha256": 7,
          buffer: 72,
        },
      ],
      47: [
      ...
      53: [
        ...
        { "../networks": 50, "../script": 67, "../types": 71, "./lazy": 55 },
      ],
      54: [
        function (require, module, exports) {
          "use strict";
      ...
      63: [
        ...
        },
        {
          ...
          "./transaction": 70,
          bip174: 39,
          "bip174/src/lib/converter/varint": 35,
          "bip174/src/lib/utils": 41,
          buffer: 72,
        },
      ],
      64: [
      ...
      72: [
        ...
        { "base64-js": 10, buffer: 72, ieee754: 76 },
      ],
      73: [
        function (require, module, exports) {
      ...
      80: [
        ...
        { "../is-buffer/index.js": 77, "./errors": 79, "./native": 82 },
      ],
      81: [
        function (require, module, exports) {
          var ERRORS = require("./errors");
